...
public void textgg (int countChar) {
		
	String mystring=Integer.toString(countChar);
	this.lblServerText.setText(mystring);
}
...
private JPanel getStringText(Font font) {
	...
	private void loadComponent() {
		...
		JPanel west = getStringText(font);
